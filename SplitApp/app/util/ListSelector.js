sap.ui.define([
   ...
   * @alias replace.namespace.util.ListSelector
   *
   */
  var ListSelector = BaseObject.extend("replace.namespace.util.ListSelector",
    /** @lends replace.namespace.util.ListSelector.prototype */
    {
      ...
      selectAListItem: function(sBindingPath) {
        ...
        this.oWhenListLoadingIsDone.then(
          ...
          function() {
            $.sap.log.warning("replace_title: Could not select the list item with the path" + sBindingPath + " because the list encountered an error or had no items");
          }
        );
      },
       ...
       * @return {replace.namespace.util.ListSelector} the list selector object for method chaining
       * @public
       */
